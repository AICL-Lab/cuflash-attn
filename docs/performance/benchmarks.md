...
> **数据快照**: v0.4.0 (2026-04-15 A100-40GB 实测)
> **当前版本**: v0.5.0 —— 注意：以下数据为 v0.4.0 快照，v0.5.0 的复测列入 [ROADMAP](https://github.com/AICL-Lab/cuflash-attn/blob/master/ROADMAP.md)；在复测完成前，引用本页数字请注明快照版本
> **测试者**: 个人维护项目（AICL-Lab）
