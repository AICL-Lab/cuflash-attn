...
export default {
  ...
  Layout() {
    return h(DefaultTheme.Layout, null, {
      ...
      // 首页 Hero 前扩展
      'home-hero-before': () => h('div', { class: 'hero-glow' }),
      
      // 首页 Hero 后扩展
      'home-hero-after': () => h('div', { class: 'hero-features' }, [
        h(FeatureCard, {
          title: '⚡ O(N) Memory',
          description: 'Linear memory complexity using FlashAttention algorithm'
        }),
        h(FeatureCard, {
          title: '🔢 FP32 & FP16',
          description: 'Full precision support for training and inference'
        }),
        h(FeatureCard, {
          title: '🚀 CUDA Optimized',
          description: 'Multi-architecture kernels for V100 to H100'
        })
      ]),
